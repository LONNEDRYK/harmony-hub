...
const Notifications = () => {
  ...
  // Generate notifications from imported tracks and videos
  useEffect(() => {
    ...
    if (notifs.length === 0) {
      notifs.push({
        id: 'welcome',
        type: 'system',
        title: 'Bienvenue sur LumyVortex',
        ...
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              {unreadCount > 0 && (
                <p className="text-xs text-primary">{unreadCount} non lue{unreadCount > 1 ? 's' : ''}</p>
              )}
            </div>
          </div>
          <button
        ...
        <div className="flex gap-2 mb-3">
          ...
          {unreadCount > 0 && (
            <button
              ...
              className="ml-auto px-3 py-1.5 rounded-full text-xs font-medium text-primary"
            >
              Tout lire
            </button>
          )}
        ...
        {filteredNotifications.length > 0 ? (
          <div className="space-y-2">
            ...
            {notifications.length > 0 && (
              <button
                onClick={clearAll}
                className="w-full py-3 rounded-lg bg-red-500/10 text-red-500 font-medium text-xs mt-3"
              >
