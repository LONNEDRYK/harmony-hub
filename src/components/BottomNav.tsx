...
const BottomNav = () => {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 z-50 bg-background/95 backdrop-blur-sm border-t border-border/10 safe-area-bottom">
      <div className="px-2 pt-2 pb-5 max-w-lg mx-auto">
        <div className="flex items-center justify-evenly">
          ...
          <button
            ...
            className="flex flex-col items-center gap-1 flex-1 min-w-0"
          >
            <div className="w-[44px] h-[44px] bg-muted-foreground/30 rounded-full flex items-center justify-center -mt-1">
              <svg width="18" height="18" viewBox="0 0 18 18" fill="none">
                <line x1="9" y1="2" x2="9" y2="16" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" className="text-foreground" />
                <line x1="2" y1="9" x2="16" y2="9" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" className="text-foreground" />
              </svg>
            </div>
          </button>
